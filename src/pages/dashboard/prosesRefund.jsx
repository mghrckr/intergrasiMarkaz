      ...
      <Card>
        ...
        <CardBody className="overflow-x-scroll px-0 pt-0 pb-2">
          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
            <div>
              ...
              <button
                ...
                style={{ backgroundColor: 'red', marginLeft: '8px', marginTop: '8px' }}
              ...
              <button
                ...
                aria-label="Export to Excel"
                title="Export to Excel"
                style={{ backgroundColor: 'green', marginLeft: '8px', marginTop: '8px' }}
                disabled={submitLoading}
              >
                UPDATE
              </button>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              <div>
                <DropdownPPOBKategori />
                <DropdownPPOBSupplier />
          ...
          <table className="w-full min-w-[640px] table-auto">
            <thead>
              <tr>
                {["ID TRX", "ID MITRA", "ID SUPP", "TGL IN", "TGL OUT", 'MEMBER', 'NO TUJUAN', 'SUPPLIER', 'VSN', 'EXEC'].map((el) => (
                  <th
                    key={el}
