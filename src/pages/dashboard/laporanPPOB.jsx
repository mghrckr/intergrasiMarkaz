...
export function LaporanPPOB() {
  ...
  const handleExportToExcel = () => {
    ...
    exportToExcel(tableData, 'PPOB_Report');
  };
    ...
    <div className="mt-12 mb-8 flex flex-col gap-12">
      ...
      <Card>
        ...
        <CardBody className="overflow-x-scroll px-0 pt-0 pb-2">
          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
            <div>
              ...
              <button
                ...
                style={{ backgroundColor: 'blue', marginTop: '8px' }}
          ...
          <div className="mb-8 mt-4 ml-1 mr-1 grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-5">
          ...
          <table className="w-full min-w-[640px] table-auto">
            <thead>
              <tr>
                {["TANGGAL", "MEMBER", "PRODUK", "IDPEL", "SUPPLIER", "JUAL", 'HPP', 'KOMISI', 'LABA', 'STATUS'].map((el) => (
                  <th
                    key={el}
